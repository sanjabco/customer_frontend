...
const GeneralDiscountItem = () => {
    return (
        <div className='bg-white py-3 rounded-3xl text-center overflow-hidden'>
            <div className='px-7'>
                <img className='mx-auto w-20' src="../../../assets/images/snap.png" alt="" />
            </div>
            <div>
                <h3 className='font-bold text-[#6F6F9D] text-sm tracking-[-1px] mt-2'>اسنپ</h3>
